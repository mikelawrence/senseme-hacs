...
* Click the **Submit** button on the popup window. The SenseME components will attempt to discover SenseME devices on the network and offer a list of available devices for the user to add to Home Assistant

## Using the SenseME integration

The SenseME integration supports speed, direction, whoosh and sleep for fans. If your fan has a light installed it will automatically be detected and added to Home Assistant.
...
There are no options for the Sensme component.
...
* Sometimes SenseME fans just don't respond to discovery packets. If you are trying to add the device you can simply use the IP address or you can try a again later when the Sensme devices are more cooperative.
